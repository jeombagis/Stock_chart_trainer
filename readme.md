# 📈 Stock Chart Trainer (스톡 차트 트레이너)

> 🔬 **비상업적 학술·연구 및 교육 목적 고지 (Non-Commercial Research & Educational Use Only)**  
> 본 프로젝트는 금융 투자 권유, 종목 추천, 또는 투자 자문과 일체 무관하며, 과거 실제 지수(S&P 500 `^GSPC`, NASDAQ-100 `^NDX`)의 10년 치 일봉 캔들 차트를 기반으로 주가 패턴을 분석하고 예측 통계를 연구하기 위한 **순수 비상업적 학술·연구용 웹 시뮬레이터**입니다.

과거 실제 시장 데이터의 무작위 구간을 탐색하며 기술적 지표와 차트 패턴에 따른 방향성(`상승`, `횡보`, `하락`) 분포를 통계적으로 학습할 수 있습니다.
